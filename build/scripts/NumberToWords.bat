...
@rem ##########################################################################
@rem
@rem  NumberToWords startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and NUMBER_TO_WORDS_OPTS to pass JVM options to this script.
...
@rem Execute NumberToWords
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NUMBER_TO_WORDS_OPTS%  -classpath "%CLASSPATH%" Scrabble %CMD_LINE_ARGS%
...
:fail
rem Set variable NUMBER_TO_WORDS_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%NUMBER_TO_WORDS_EXIT_CONSOLE%" exit 1
exit /b 1
